...
describe('TweetsService', () => {
  ...
  describe('createTweet', () => {
    ...
    it('should prevent tweets over 100 characters', () => {
      // Arrange
      const payload =
        ' This is a long tweet over 100 characters This ia a long tThis is a long tweet over 100 characters This ia a long tThis is a long tweet over 100 characters This ia a long tThis is a long tweet over 100 characters This ia a long tThis is a long tweet over 100 characters This ia a long t...';
  ...
  describe('getTweets', () => {
    it('geiTweets', () => {
      service.tweets = ['test get', 'this is a tweet', 'another tweet'];
  ...
  describe('deleteTweet', () => {
    it('should delete and return tweet', () => {
      ...
      expect(tweet[0]).toBe('hello world');
